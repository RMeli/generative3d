...
to_keep = ['Compound_ID', 'SMILES', 'Chemical Series', 'Experimental Result, Average Value', 'Experimental Result, Unit', 'PDB ID']
df = df[to_keep]

to_rename = {"Compound_ID": "compound", "Chemical Series": "series", 'Experimental Result, Average Value': "Kd", 'Experimental Result, Unit': "unit", 'PDB ID': "pdbid"}
